      ...
      <div className="z-10 text-center rounded-2xl bg-opacity-60 backdrop-filter backdrop-blur-sm bg-white py-[26px] px-[40px] text-[#FF5065] text-3xl justify-center items-center flex flex-col" >
        <form className="flex flex-col gap-[24px] justify-center items-center" action="login.php" method="post">
          ...
          <input
            type="text"
            name="serial"
            className={sniglet.className + " text-[18px] flex self-stretch py-[5px] px-[12px] items-center flex-[1_0_0] border-[1px] rounded-xl border-solid border-[#FF7485]"}
            placeholder="xxxxxx"
            required
          />
          <button type="submit" className=" bg-[#FF7485] px-[16px] py-[4px] border-[1px] rounded-xl border-[#FF7485]">
